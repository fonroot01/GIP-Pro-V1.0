...
from PyQt6.QtWidgets import QWidget, QVBoxLayout, QLabel, QListWidget, QPushButton, QHBoxLayout, QGroupBox, QSizePolicy, QFrame
...
class TabHistory(QWidget):
    ...
    def init_ui(self):
        self.setStyleSheet('''
            ...
            QListWidget { border: 1px solid #888; border-radius: 3px; background: #181a1b; color: #e0e0e0; }
        ''')
        main_layout = QVBoxLayout(self)
        main_layout.setAlignment(Qt.AlignmentFlag.AlignTop)
        main_layout.setContentsMargins(16, 16, 16, 12)
        main_layout.setSpacing(12)
        group = QGroupBox("Historial de Cambios")
